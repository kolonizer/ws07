function CreateMonster(id, tip)
    ...
    if tip == 'Slime' then
        Objects[#Objects + 1] = { id = id, cellX = id % n, cellY = math.floor(id / n) + 1,
		name = "Slime", Type = "circle", mode = "line", sprite = newSpr("spr/modelSlime", 51, 51, 0.5, 1, 2),
		x = collide.XYFromID(id)[1] * size + e_x, y = (collide.XYFromID(id)[2] + 2) * size + e_y,
    ...
    if tip == 'Ghost' then
        Objects[#Objects + 1] = { id = id, cellX = id % n, cellY = math.floor(id / n) + 1,
		name = "Ghost", Type = "circle", mode = "line", sprite = newSpr("spr/modelGost", 51, 51, 0.8, 1, 2),
		x = collide.XYFromID(id)[1] * size + e_x, y = (collide.XYFromID(id)[2] + 2) * size + e_y,
    ...
    if tip == 'Wolf' then
        Objects[#Objects + 1] = { id = id, cellX = id % n, cellY = math.floor(id / n) + 1,
		name = "Wolf", Type = "circle", mode = "line", sprite = newSpr("spr/modelWolf", 51, 51, 0.51, 1, 2),
		x = collide.XYFromID(id)[1] * size + e_x, y = (collide.XYFromID(id)[2] + 2) * size + e_y,
